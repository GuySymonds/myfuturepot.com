      ...
      <div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <SliderInput
            ...
            formatDisplay={(v) => formatPercent(v)}
            helpText="The assumed rate at which prices rise over time (sometimes called inflation). This is used to show what the pot might feel like in today's money."
          />
        </div>
      </div>
